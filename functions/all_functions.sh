...
declare -x -f dbDeleteFromDbUsers #удаление пользователя $1 из базы данных $WEBSERVER_DB.users: ($1-user ; $2-"delete")
#удаление пользователя $1 из базы данных $WEBSERVER_DB.users
