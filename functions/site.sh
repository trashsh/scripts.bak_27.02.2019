...
declare -x -f chOwn #Смена владельца на файлы: ($1-path; $2-user; $3-group)
...
#return 0 - выполнено успешно, 1 - файл уже существует, 2 - пользователь не существует
