...
echo ''
echo -e -n "$COLOR_BLUE"Укажите первую дату диапазона в формате yyyy-mm-dd:" $COLOR_NC"
read DATE1
echo -e -n "$COLOR_BLUE"Укажите последнюю дату диапазона в формате yyyy-mm-dd:" $COLOR_NC"
read DATE2
